...
@section('content')
    <div class="min-h-screen" style="background:#f1f5f9;">
        <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div id="panel-input">
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 mb-8">
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Data Collection</h2>
                    </div>
            ...
            {{-- ══ RINGKASAN TERBARU ══ --}}
            <div id="panel-ringkasan" class="hidden">
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
                    <div class="px-8 py-5 border-b border-slate-100">
                        <div class="flex items-center space-x-3">
                            <div class="w-1 h-6 bg-red-600 rounded-full"></div>
                            <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Ringkasan Data Terbaru C3MR</h2>
                        </div>
                    </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="py-16 text-center">
                                        ...
                                        <p class="text-sm font-bold text-slate-400">Belum Ada Data Billing Perdana</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
