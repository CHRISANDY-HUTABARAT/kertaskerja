...
@section('content')
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div>
                            ...
                            <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">
                                <span class="text-red-600">Collections</span> UTIP
                            </h1>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    <div class="px-8 py-5 border-b border-slate-100">
                        <div class="flex items-center space-x-3">
                            <div class="w-1 h-6 bg-red-600 rounded-full"></div>
                            <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Status Terbaru UTIP</h2>
                        </div>
                    </div>
    ...
    <script>
        ...
        function autoFillFromExcel(input) {
            ...
            fetch('{{ route('admin.utip.previewImport') }}', {
                method: 'POST',
                body: formData,
