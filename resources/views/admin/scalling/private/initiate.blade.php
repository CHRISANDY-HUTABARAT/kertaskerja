...
@section('title', 'Admin - LOP Initiate - Private')
    ...
    <div class="min-h-screen" style="background:#f1f5f9;">
        <div class="max-w-7xl mx-auto px-8 py-10">
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div>
                            ...
                            <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">
                                Kelola data LOP Initiate &mdash; <span class="text-red-500">Private</span>
                            </p>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols gap-4 mb-8">
                <a href="{{ route('admin.progress', ['segment' => 'private', 'type' => 'initiate']) }}"
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
                <div class="px-8 py-5 border-b border-slate-100">
                    <div class="flex items-center space-x-3">
                        <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                        <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Data LOP Initiate —
                            Private</h2>
                    </div>
                </div>
                <div class="p-8">
                    <form action="{{ route('admin.scalling.private.initiate.storeData') }}" method="POST">
                        @csrf
