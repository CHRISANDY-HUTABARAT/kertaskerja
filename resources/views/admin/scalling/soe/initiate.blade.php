...
@section('title', 'Admin - LOP Initiate - SOE')
...
@section('content')
    <div class="min-h-screen" style="background:#f1f5f9;">
        ...
        <div class="grid grid-cols gap-4 mb-8">
            <a href="{{ route('admin.progress', ['segment' => 'soe', 'type' => 'initiate']) }}"
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('admin.scalling.soe.initiate.storeData') }}" method="POST">
                        @csrf
