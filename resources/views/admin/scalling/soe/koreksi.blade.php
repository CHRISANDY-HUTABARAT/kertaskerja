    ...
    <div class="min-h-screen" style="background:#f1f5f9;">
        <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div class="grid grid-cols gap-4 mb-8">
                <a href="{{ route('admin.progress', ['segment' => 'soe', 'type' => 'koreksi']) }}"
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 mb-8">
                ...
                <form action="{{ route('admin.scalling.soe.koreksi') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl relative overflow-hidden">
            ...
            <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-slate-400 font-medium mt-0.5">SOE — Scalling Koreksi</p>
                </div>
            ...
            {{-- Modal body --}}
            <form action="{{ route('admin.scalling.soe.koreksi.storeData') }}" method="POST">
                @csrf
                <input type="hidden" name="type" value="koreksi">
