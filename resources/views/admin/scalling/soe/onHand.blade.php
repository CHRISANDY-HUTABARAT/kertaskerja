...
@section('content')
    <div class="min-h-screen" style="background:#f1f5f9;">
        <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div class="grid grid-cols gap-4 mb-8">
                <a href="{{ route('admin.progress', ['segment' => 'soe', 'type' => 'on-hand']) }}"
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 mb-8">
                ...
                <form action="{{ route('admin.scalling.soe.on-hand.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <div id="modalAddLop" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl relative overflow-hidden">
            ...
            {{-- Modal body --}}
            <form action="{{ route('admin.scalling.soe.on-hand.storeData') }}" method="POST">
                @csrf
                <input type="hidden" name="type" value="on-hand">
