...
@section('title', 'Admin - Rising Star 2')
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">
                            <span class="text-red-600">Rising</span> Star 2
                        </h1>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            <div class="px-8 py-5 border-b border-slate-100">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Data Rising Star 2</h2>
                </div>
            </div>
            <div class="p-8">
                <form action="{{ route('admin.rising-star.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-6">
                        ...
                        <div>
                            ...
                            <input type="number" step="any" name="commitment" value="{{ old('commitment') }}" placeholder="cth: 98.50"
                                class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 focus:outline-none focus:border-red-400 focus:ring-1 focus:ring-red-100 transition-colors">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Realisasi (%)</label>
                            <input type="number" step="any" name="real_ratio" value="{{ old('real_ratio') }}" placeholder="cth: 95.50"
                                class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 focus:outline-none focus:border-red-400 focus:ring-1 focus:ring-red-100 transition-colors">
                        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="px-8 py-5 border-b border-slate-100">
                <div class="flex items-center justify-between mb-5">
                    <div class="flex items-center space-x-3">
                        <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                        <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Data Rising Star 2</h2>
                    </div>
                ...
                <form method="GET" action="{{ route('admin.rising-star2') }}" class="grid grid-cols-4 gap-3">
                    <div>
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.rising-star2') }}"
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr>
                            <td colspan="7" class="py-16 text-center bg-white">
                                ...
                                <p class="text-sm font-bold text-slate-400">Belum ada data Rising Star 2</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
