...
@section('title', 'Admin - Rising Star 3')
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">
                            <span class="text-red-600">Rising</span> Star 3
                        </h1>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            <div class="px-8 py-5 border-b border-slate-100">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Data Rising Star 3</h2>
                </div>
            </div>
            <div class="p-8">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="px-8 py-5 border-b border-slate-100">
                <div class="flex items-center justify-between mb-5">
                    <div class="flex items-center space-x-3">
                        <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                        <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Data Rising Star 3</h2>
                    </div>
                ...
                <form method="GET" action="{{ route('admin.rising-star3') }}" class="grid grid-cols-4 gap-3">
                    <div>
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.rising-star3') }}"
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr>
                            <td colspan="7" class="py-16 text-center bg-white">
                                ...
                                <p class="text-sm font-bold text-slate-400">Belum ada data Rising Star 3</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
