...
@section('title', 'SOE - LOP Qualified')
    ...
    <div class="max-w-7xl mx-auto px-8 py-10">
        ...
        <div class="flex items-center justify-between mb-5">
            ...
            <div class="flex items-center space-x-3">
                ...
                <span class="text-[10px] font-black tracking-widest text-slate-500 bg-white border border-slate-200 rounded-md px-3 py-1 uppercase shadow-sm">SOE</span>
