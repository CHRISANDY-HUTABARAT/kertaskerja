...
@section('content')
    <div class="min-h-screen" style="background:#f1f5f9;">
        <div class="max-w-7xl mx-auto px-8 py-10">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        ...
                        <div>
                            ...
                            <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">AR <span
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
                ...
                <div class="p-8">
                    <form action="{{ route('collection.ar.storeRealisasi') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-4 gap-5 mb-5">
                            ...
                            <div>
                                ...
                                <select name="segment" required onchange="checkArLocked(this.value)"
                                    class="w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm font-semibold text-slate-800 focus:outline-none focus:border-red-400 bg-white">
                                ...
                                <div id="ar-locked-warning" class="hidden mt-2 flex items-center space-x-2 text-amber-700 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
                                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                                    </svg>
                                    <p class="text-xs font-bold">Tipe AR ini sudah dinonaktifkan.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end space-x-3 mt-6">
                            ...
                            <button type="submit" id="btn-ar-simpan"
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="px-8 py-5 border-b border-slate-100">
                    <div class="flex items-center space-x-3 mb-5">
                        <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                        <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Riwayat Aktivitas AR</h2>
                    </div>
                    <form method="GET" action="{{ route('collection.ar') }}" class="grid grid-cols-5 gap-3">
                        <div>
    ...
    <script>
        function checkArLocked(type) {
            const btn     = document.getElementById('btn-ar-simpan');
            const warning = document.getElementById('ar-locked-warning');
