...
@section('title', 'Collection - CYC Management')
...
@section('content')
    <div class="min-h-screen" style="background:#f1f5f9;">
        <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            @if(session('error'))
                <div id="flash-error"
                    class="flex items-center space-x-3 bg-red-50 border border-red-200 text-red-800 px-5 py-3.5 mb-6 rounded-xl text-sm font-semibold duration-300">
            ...
            <form method="GET" action="{{ route('collection.cyc') }}" class="mb-6" id="form-periode">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
                <div class="px-8 py-5 border-b border-slate-100 flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Realisasi CYC</h2>
                            <p class="text-xs text-slate-400 font-semibold mt-0.5">Pilih segment lalu catat realisasi CYC.</p>
                        </div>
                    </div>
                ...
                <div class="p-8">
                    <form action="{{ route('collection.cyc.storeRealisasi') }}" method="POST">
                        @csrf
                        ...
                        <script>
                            ...
                            const lockedSegments = @json($lockedSegments);
                        </script>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="px-8 py-5 border-b border-slate-100">
                    <div class="flex items-center justify-between mb-5">
                        <div class="flex items-center space-x-3">
                            <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                            <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Riwayat Aktivitas CYC</h2>
                        </div>
                    </div>
                    <form method="GET" action="{{ route('collection.cyc') }}" class="grid grid-cols-5 gap-3">
                        <div>
    ...
    <script>
        setTimeout(() => {
            ...
            if (flashErr) {
                flashErr.classList.add('opacity-0');
