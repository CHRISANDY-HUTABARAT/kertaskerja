            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">C3MR <span class="text-red-600">Management</span></h1>
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Customer Credit Management & Monitoring Report</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            <div class="px-8 py-5 border-b border-slate-100 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Realisasi C3MR</h2>
            ...
            <div class="p-8">
                ...
                @else
                <form action="{{ route('collection.c3mr.storeRealisasi') }}" method="POST">
                    @csrf
                    <input type="hidden" name="periode" value="{{ $selectedPeriode . '-01' }}">
                    <div class="max-w-md mx-auto space-y-5">
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 text-center">Realisasi C3MR (%)</label>
                            <div class="relative">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-8 py-5 border-b border-slate-100">
                <div class="flex items-center justify-between mb-5">
                    <div class="flex items-center space-x-3">
                        <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                        <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Riwayat Aktivitas C3MR</h2>
                    </div>
                </div>
                <form method="GET" action="{{ route('collection.c3mr') }}" class="grid grid-cols-4 gap-3">
                    <div>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center font-black text-slate-700">
                                {{ number_format($activity->commitment ?? 0, 2) }}%
                            </td>
                            <td class="px-6 py-4 text-center font-black {{ $activity->type == 'C3MR' ? 'text-red-600' : 'text-green-600' }}">
