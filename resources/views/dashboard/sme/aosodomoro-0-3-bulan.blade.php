...
@section('title', 'Aosodomoro 0-3 Bulan')
...
<div class="min-h-screen" style="background:#f1f5f9;">
    <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">Aosodomoro <span class="text-red-600">0–3 Bulan</span></h1>
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Input Realisasi Aosodomoro Periode 0 sampai 3 Bulan</p>
                    </div>
                </div>
        ...
        <form method="GET" action="{{ route('dashboard.sme.aosodomoro-0-3-bulan') }}" class="mb-6" id="form-periode">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            ...
            <div class="p-8">
                ...
                @else
                <form method="POST" action="{{ route('dashboard.sme.aosodomoro-0-3-bulan.store') }}">
                    @csrf
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-8 py-5 border-b border-slate-100">
                ...
                <form method="GET" action="{{ route('dashboard.sme.aosodomoro-0-3-bulan') }}" class="grid grid-cols-4 gap-3">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('dashboard.sme.aosodomoro-0-3-bulan') }}"
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr>
                            <td colspan="5" class="py-16 text-center">
                                ...
                                <p class="text-sm font-bold text-slate-400">Belum Ada Data Aosodomoro 0-3 Bulan</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
