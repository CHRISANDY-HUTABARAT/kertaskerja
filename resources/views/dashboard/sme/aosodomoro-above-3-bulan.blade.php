...
<div class="min-h-screen" style="background:#f1f5f9;">
    <div class="max-w-7xl mx-auto px-8 py-10">
        ...
        <form method="GET" action="{{ route('dashboard.sme.aosodomoro-above-3-bulan') }}" class="mb-6" id="form-periode">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            ...
            <div class="p-8">
                ...
                @else
                <form method="POST" action="{{ route('dashboard.sme.aosodomoro-above-3-bulan.store') }}">
                    @csrf
