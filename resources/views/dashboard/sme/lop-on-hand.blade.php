        ...
        <div class="flex items-center justify-between mb-5">
            ...
            <div class="flex items-center space-x-3">
                ...
                <input
                    type="text"
                    id="searchInput"
                    placeholder="Cari Project, ID LOP, AM, CC..."
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl relative overflow-hidden">
            ...
            <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-slate-400 font-medium mt-0.5">SME — Scalling On Hand</p>
                </div>
            ...
            {{-- Modal body --}}
            <form action="{{ route('dashboard.sme.add-data') }}" method="POST">
                @csrf
