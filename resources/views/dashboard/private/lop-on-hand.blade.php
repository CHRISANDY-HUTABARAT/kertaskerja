...
@section('title', 'Private - LOP On Hand')
    ...
    <div class="max-w-7xl mx-auto px-8 py-10">
        ...
        <div class="flex items-center justify-between mb-5">
            ...
            <div class="flex items-center space-x-3">
                ...
                <span class="text-[12px] font-black tracking-widest text-slate-500 bg-white border border-slate-200 rounded-md px-3 py-1 uppercase shadow-sm">PRIVATE</span>
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl relative overflow-hidden">
            ...
            <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-slate-400 font-medium mt-0.5">Private — Scalling On Hand</p>
                </div>
